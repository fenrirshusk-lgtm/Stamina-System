...
# ----- EP Costs -----
ep_power1 = compute_stat_cost(power1, power1_inactive, apply_upkeep=upkeep)
ep_power2 = compute_stat_cost(power2, power2_inactive)
ep_range = compute_stat_cost(range_stat, range_inactive)

# ----- Mobility Cost (special: divide and round to nearest whole) -----
...
# ----- Total Cost (no rounding unless .25/.75) -----
...
if remainder in [0.25, 0.75]:
    ...
    total_cost = raw_total  # don't round .5
